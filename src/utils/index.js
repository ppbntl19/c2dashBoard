...
export function translateDataToTree(data) {
  ...
  let parents = data.filter((value) => value.parent[0] === '0')

  //data with parent node
  let children = data.filter((value) => value.parent[0] !== '0')
  ...
  let translator = (parents, children) => {
    ...
    parents.forEach((parent) => {
      ...
      children.forEach((current, index) => {
        ...
        if (current.parent[current.parent.length - 1] === parent._id) {
...
/**
 * Remove the tree structure children null value, adapt to the element ui component
 * @param {*} data
 */
export function removeEmptyChildren(data) {
  data.forEach((v) => {
    let childrens = v.children || []
...
//Cloudnary image details
export const CLOUDNARY_URL =
  process.env.CLOUDNARY_URL || 'https://api.cloudinary.com/v1_1'
export const CLOUDNARY_NAME = process.env.CLOUDNARY_NAME || 'db0gq7w3r'
export const CLOUDNARY_PRESET = process.env.CLOUDNARY_PRESET || 'sg9szjpu'
